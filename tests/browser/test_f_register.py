...
LOCATIONS = {"uk-ua": ["Автономна Республіка Крим", "Бахчисарайський", "Ароматненська"],
...
def individual(selenium, idx=0, role="head", collector=False, tax_id=None, passport=None,
               birth_date="2000-01-01", birth_certificate=None, birth_certificate_picture=None):
    ...
    select = Select(selenium.find_element(By.CSS_SELECTOR,
                                          f'select[name="individuals-{idx}-relationship_i_c"]'))
...
def test_ukr_base(live_server, selenium, language, url):
    ...
    individual(selenium, 1, role="son_daughter", collector=False, birth_date="2022-06-01",
               birth_certificate='12345', birth_certificate_picture=birth_certificate_picture)

    selenium.find_by_css('.formset.formset-individuals a.formset-add-button').click()
    individual(selenium, 2, role="son_daughter", collector=False, birth_date="2022-06-01",
               birth_certificate='12345', birth_certificate_picture=birth_certificate_picture)

    selenium.find_by_css('.formset.formset-individuals a.formset-add-button').click()
    individual(selenium, 3, role="son_daughter", collector=False, birth_date="2022-06-01",
               birth_certificate='12345', birth_certificate_picture=birth_certificate_picture)
    ...
    assert Record.objects.get(id=id,
...
def test_not_eligible(live_server, selenium, language, url):
    ...
    with translation.override(language):
        ...
        assert gettext('Your household information does not meet the '
                       'eligibility criteria for UNICEF cash assistance') in page
