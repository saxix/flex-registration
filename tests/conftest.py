...
def simple_form():
    ...
    v1, __ = Validator.objects.get_or_create(name='length_2_25',
                                             defaults=dict(message="String size 1 to 5",
...
def complex_form():
    ...
    hh.fields.get_or_create(label='Family Name', defaults={'field': forms.CharField, 'required': True,
                                                           'validator': v1})

    ind, __ = FlexForm.objects.get_or_create(name='Form1')
    ...
    ind.fields.get_or_create(label='Date Of Birth', defaults={'field': forms.DateField,
                                                              'required': True})
