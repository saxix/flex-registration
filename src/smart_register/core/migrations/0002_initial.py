    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parent', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='formsets', to='core.flexform')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='flexform',
            name='validator',
            field=models.ForeignKey(blank=True, limit_choices_to={'target': 'form'}, null=True, on_delete=django.db.models.deletion.PROTECT, to='core.validator'),
        ),
        migrations.CreateModel(
            name='FlexFormField',
            fields=[
                ...
                ('validator', models.ForeignKey(blank=True, limit_choices_to={'target': 'field'}, null=True, on_delete=django.db.models.deletion.PROTECT, to='core.validator')),
            ],
            options={
