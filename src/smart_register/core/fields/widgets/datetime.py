...
class SmartDateWidget(forms.DateInput):
    ...
    def __init__(self, attrs=None, format=None):
        attrs = {"class": "shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight"
                          " focus:outline-none focus:shadow-outline vDateField", "size": "10", **(attrs or {})}
